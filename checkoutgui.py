...
class New_Toplevel:
    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                ...
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "No Guests Found""\n")

                    elif n == 1:

                        self.Text1.insert(INSERT, "Thank You  " + name1.upper() + " for Visiting Us.""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
                ...
                self.Text1.insert(INSERT, "Invalid Room Number, Please input a valid ROOM NO.""\n")
        ...
        font11 = "-family {Trebuchet MS Bold} -size 23 -weight bold -slant "  \
            "roman -underline 1 -overstrike 0"
        font12 = "-family {Segoe UI} -size 24 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font9 = "-family {Segoe UI} -size 16 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Label1.configure(text='''Enter Room Number:''')
        ...
        self.Text1.configure(background="#000099")
        self.Text1.configure(font=font9)
        self.Text1.configure(foreground="White")
