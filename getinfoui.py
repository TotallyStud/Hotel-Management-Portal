...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        font11 = "-family {Segoe UI} -size 22 -weight bold -slant "  \
            "roman -underline 2 -overstrike 0"
        font9 = "-family {Segoe UI} -size 23 -weight bold -slant roman"  \
            " -underline 0 -overstrike 0"
        font6 = "-family {Segoe UI} -size 13 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Text1.configure(background="Black")
        self.Text1.configure(font=font6)
        self.Text1.configure(foreground="#00ff00")
        ...
        self.Message1.configure(text='''Room Number Validation Portal.''')
