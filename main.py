...
def chk_day():
    while True:
        print("\n")
        no_of_days = input("Enter Number of Days Guest want to Stay:")
...
class save:
    ...
    def bill(self):
        print("\n")
        print("@@@@@@@@@  TotallyStud Hotel & Resort  @@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@ City, State @@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@ Serving Guests Since @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@    ###2020###       @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
