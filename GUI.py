...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        _ana1color = '#ffffff' 
        _ana2color = '#ffffff' 
        font14 = "-family {Trebuchet MS Bold} -size 15 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font16 = "-family {Swis721 BlkCn BT} -size 40 -weight bold "  \
            "-slant roman -underline 1 -overstrike 0"
        font9 = "-family {Segoe UI} -size 9 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
        font2 = "-family {Sitka Text} -size 40 -weight bold -slant "  \
            "roman -underline 1 -overstrike 0"

        root.geometry("963x749+540+110")
        root.title("Hotel Managing Portal")
        root.configure(background="#000000")
        root.configure(highlightbackground="#33ccff")
        ...
        self.Message6.configure(font=font2)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''Hotel Booking Portal.''')
        ...
        self.Button2.configure(text='''Checking In.''')
        ...
        self.Button3.configure(text='''Guests List.''')
        ...
        self.Button4.configure(text='''Checking Out.''')
        ...
        self.Button5.configure(text='''Validate Room Numbers.''')
        ...
        self.Button6.configure(background="#0066ff")
        ...
        self.Button6.configure(text='''Close Portal''')
        self.Button6.configure(width=566)
        self.Button6.configure(command=quit)
        root.mainloop()

        self.Button7 = Button(self.Frame1)
        self.Button7.place(relx=0.18, rely=0.17, height=10, width=566)
        self.Button7.configure(activebackground="#d9d9d9")
        self.Button7.configure(activeforeground="#000000")
        self.Button7.configure(background="#0066ff")
        ...
        self.Button7.configure(command=df.toexcel)
